...
def scrape_with_playwright(urls):
    """Scrape and split text from web pages"""
...
def preprocess_text_to_vector(documents: list[langchain.schema.document.Document]) -> dict:
    """Preprocess before sending to embedding function"""
...
def get_url_habr_articles():
    """Get urls of habr articles"""
    ...
    return habr_article_urls


if __name__ == "__main__":
    if not os.path.exists("emergency_data_storage.json"):
        habr_article_urls = get_url_habr_articles()
